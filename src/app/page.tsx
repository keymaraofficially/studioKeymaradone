    ...
    <div className="flex flex-col">
      <section className="hero-section px-6 py-20 max-w-5xl mx-auto text-center">
        <h1 className="hero-title">
          Become a <span className="brevo-strong">Brevo</span>-Powered Email Marketer
        </h1>
      ...
      <section className="py-12 bg-card text-center">
        <div className="w-full overflow-hidden relative">
          <h3 className="text-xl md:text-2xl font-semibold text-foreground mb-8 px-4">
            Join 500,000+ customers around the world who trust <span className="brevo-strong">Brevo</span>
          </h3>
      ...
      <section className="bg-background text-foreground py-20 md:py-24">
        <div className="container max-w-7xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-2.5">Why Marketers Prefer <span className="brevo-strong">Brevo</span> for Email Automation</h2>
      ...
      <section className="py-16 bg-card rounded-2xl my-16">
        <div className="container max-w-6xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-5">
            <span className="brevo-strong">Brevo</span> is Used Worldwide — Every Single Month
          </h2>
      ...
      <section className="py-20 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-headline font-bold">How <span className="brevo-strong">Brevo</span> AI Helps You Grow Smarter</h2>
       ...
       <section className="py-16 bg-card">
        <div className="container max-w-6xl mx-auto">
            ...
            <span className="brevo-strong">Brevo</span> Integrations That Power Your Marketing
            </h2>
      ...
      <section className="py-20 bg-background text-foreground">
        <div className="container max-w-7xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-2.5">Enterprise Power with <span className="brevo-strong">Brevo</span> Intelligence</h2>
          <p className="text-muted-foreground mb-9 text-lg px-4">
          ...
          <div className="container mx-auto max-w-6xl py-12 px-4 md:px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-foreground">
                Real Brands Growing Faster With <span className="brevo-strong">Brevo</span>
              </h2>
      ...
      <section className="py-20 bg-card">
        <div className="container max-w-6xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-headline font-bold mb-8">
            Dive Deeper into <span className="brevo-strong">Brevo</span>
          </h2>
