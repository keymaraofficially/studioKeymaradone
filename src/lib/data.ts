...
export const latestInsights = [
  ...
  },
  {
    ...
    description: 'A deep beginner-friendly guide to Mailchimp. Learn how Mailchmp’s email builder, automation tools, customer journeys, segmentation, analytics, and pricing work for businesses of all sizes.',
    category: 'Tools & SaaS',
    image: 'saas-ad',
    author: 'Keymara Team',
  ...
  },
  {
    ...
    glossary: 'Multi-channel Messaging: The practice of using multiple communication channels like email, SMS, and WhatsApp to engage with customers throughout their journey.',
    facts: ['Businesses that use three or more channels in a campaign see a 287% higher purchase rate than those using a single-channel campaign.', 'SMS messages have a 98% open rate, compared to about 20% for email.'],
  ...
  },
  {
    ...
    category: 'Brevo Tools Comparison Hub',
    image: 'comparison-ad',
    author: 'Alex Morgan',
    date: 'November 19, 2025',
